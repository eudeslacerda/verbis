...
<div class="col-md-8 order-md-1">
    <form name="frmUserNew" enctype="multipart/form-data" action="<?= $actionForm ?>" method="post" accept-charset="uft-8" class="needs-validation" novalidate>
        ...
        <div class="mb-3">
            ...
            <input value="<?= $role->getName() ?>" tabindex="1" name="txtRole" type="text" class="form-control" id="txtRole" placeholder="<?= Kohana::message('role', 'role.singular') ?>" required />
        ...
        <div class="mb-3">
            ...
            <textarea name="txtDescription" class="form-control" id="txtDescription" required><?= $role->getDescription() ?></textarea>
            <div class="invalid-feedback"><?= Kohana::message('warning', 'requiredField') ?></div>
        </div>
    </form>
</div>
