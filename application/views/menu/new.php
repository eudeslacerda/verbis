<div class="col h1"><?= Kohana::message('page', 'new.male') . " " . Kohana::message('menu', 'menu.singular') ?></div>
<div class="col-md-8 order-md-1">
    <form name="frmUserNew" enctype="multipart/form-data" action="<?= $actionForm ?>" method="post" accept-charset="uft-8" class="needs-validation" novalidate>
        ...
        <div class="mb-3">
            ...
            <input tabindex="2" name="txtMenu" type="text" class="form-control" id="txtMenu" placeholder="<?= Kohana::message('menu', 'menu.singular') ?>" required />
            <div class="invalid-feedback"><?= Kohana::message('warning', 'requiredField') ?></div>
        </div>
        <div class="mb-3">
            <label for="txtAddress"><?= Kohana::message('menu', 'address') ?></label>
            <input tabindex="3" name="txtAddress" type="text" class="form-control" id="txtAddress" placeholder="<?= Kohana::message('menu', 'address') ?>" required />
            <div class="invalid-feedback"><?= Kohana::message('warning', 'requiredField') ?></div>
        </div>
        <div class="mb-3">
            <label for="txtOrdinance"><?= Kohana::message('menu', 'ordinance') ?></label>
            <input tabindex="4" name="txtOrdinance" type="number" class="form-control" id="txtOrdinance" required/>
            <div class="invalid-feedback"><?= Kohana::message('warning', 'requiredField') ?></div>
        </div>
        <div class="mb-3">
            <input tabindex="5" name="chkPublished" type=checkbox id="chkPublished" required/>
