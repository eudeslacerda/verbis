...
<div class="col-md-8 order-md-1">
    <form name="frmUserNew" enctype="multipart/form-data" action="<?= $actionForm ?>" method="post" accept-charset="uft-8" class="needs-validation" novalidate>
        ...
        <div class="mb-3">
            ...
            <input value="<?= $theme->getTheme() ?>" tabindex="1" name="txtTheme" type="text" class="form-control" id="txtTheme" placeholder="<?= Kohana::message('theme', 'theme.singular') ?>" required />
        ...
        <div class="mb-3">
            ...
            <input value="<?= $theme->getValidity() ?>" tabindex="2" name="txtValidity" type="date" class="form-control" id="txtValidity" placeholder="<?= Kohana::message('theme', 'Validity') ?>" required />
            <div class="invalid-feedback"><?= Kohana::message('warning', 'requiredField') ?></div>
        </div>
        <div class="mb-3">
            <label for="txtDescription"><?= Kohana::message('theme', 'description') ?></label>
            <textarea name="txtDescription" class="form-control" id="txtDescription" required><?= $theme->getDescription() ?></textarea>
            <div class="invalid-feedback"><?= Kohana::message('warning', 'requiredField') ?></div>
        </div>
    </form>
</div>
