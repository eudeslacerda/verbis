...
$proposta = "Precisa estudar para a segunda etapa do PAS - UNB? Está no 9º ano da "
        . "Escola Estadual Major Saint´Clair? Aproveite, temos temas especiais direcionados "
...
<div class="container marketing">
    ...
    <div class="row">
        <center>
            ...
            <div style="float: left" class="col-lg-4">
                ...
                <p style="text-align: justify">
                    Não é possível que o envio de redações para correção seja em tempo ilimitado e, muito menos em 
                    quantidade ilimitada. Por isso, para que tenhamos um maior controle dessa situação, criamos o 
                    método de envio por chaves. Somente as primeiras 40 redações(20 de cada instituição) serão aceitas. 
                    Para mais informações, acesse a opção abaixo.
                </p>
            ...
            <div style="float: left" class="col-lg-4">
                ...
                <h2>Redações!</h2>
                <p style="text-align: justify">
                    Para que suas redações sejam enviadas e corrigidas corretamente, é necessário que seu login seja 
                    efetuado com sucesso e que a chave utilizada esteja dentro do prazo de validade. Confira também 
                    se o arquivo que será enviado está no formato "PDF". Para mais informações, acesse a opção abaixo 
                    para ser redirecionado ao menu "Redações".
                </p>
    ...
    <div class="row featurette">
        <div class="col-md-7 order-md-2">
            ...
            <h2 style="text-align: center"><span class="text-muted">A MATERNIDADE PRECOCE NO BRASIL</span></h2><br>

            <p class="lead" style="text-align: justify">
                Está no 9º ano da Escola Estadual Major Saint´Clair? Aproveite, temos um 
            ...
            <p style="text-align: center">
                <a class="btn btn-primary" href="storage/document/gravidez adolescencia TEMA ESPECIAL MAJOR.pdf" role="button">Textos Motivadores &raquo;</a>
                <a class="btn btn-primary" href="storage/document/rascunho.pdf" role="button">Rascunho &raquo;</a>
            </p>
        </div>

        <div class="col-md-5 order-md-1">
            <img src="storage/media/images/tema do 9º ano.png" width="390" height="400">
        </div>
    </div>
