<div class="col h1"><?= Kohana::message('page', 'update') . " " . Kohana::message('institution', 'institution.singular') ?></div>
<div class="col-md-8 order-md-1">
    <form name="frmUserNew" enctype="multipart/form-data" action="<?= $actionForm ?>" method="post" accept-charset="uft-8" class="needs-validation" novalidate>
        ...
        <div class="mb-3">
            ...
            <input tabindex="1" name="txtInstitution" type="text" class="form-control" id="txtInstitution" placeholder="<?= Kohana::message('institution', 'institution.singular') ?>" value="<?php echo $institution->institution?>" required />
